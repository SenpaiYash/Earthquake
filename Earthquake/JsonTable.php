...
<body>
    ...
    <nav class="navbar navbar-expand-sm  navbar-dark bg-dark">
        <a class="navbar-brand" href="index.php"><img src="image/Icon.jpg" alt="Icon"
 ...
 <h2><i class="fas fa-table"></i> Json Data Table</h2>
...
//foreach loop for 
/*foreach($Geo->features as $Geo_Child){
 echo $Geo_Child->properties->mag ."<br>";
} 

//foreach loop to store into Array
foreach($Geo->features as $Geo_Child){
  $Geo_Kid=$Geo_Child->properties->type ;
  $Geo_Kid3= explode("Alo",$Geo_Kid);
...
// //foreach loop for coordinates
// foreach($Geo->features as $Geo_Key){
//   $Geo_Key2 = $Geo_Key-> geometry->coordinates;  
//   $Geo_Key3 = json_encode($Geo_Key2);
//   $Geo_Children = explode(',', $Geo_Key3);
//   echo $Geo_Children[0];
...
<label for="search"><i class="fas fa-search"></i> Search:</label>
    ...
    <table class="table" id="table-id">
        ...
        <tr>
            <th id="type">Type</th>
            <th>Location</th>
            <th id="Mag">Magnitude</th>
            <th>Coordinates</th>
            <th>Tsunami Caused</th>

        </tr>

            <?php foreach($Geo->features as $Geo_Key): ?>
            <tr>
                <td><?php echo $Geo_Key->properties->type;?></td>
                <td><?php echo $Geo_Key->properties->place;?></td>
                <td><?php echo $Geo_Key->properties->mag;?></td>
                <td><?php echo json_encode($Geo_Key->geometry->coordinates);?></td>
                <td><?php echo $Geo_Key->properties->tsunami;?></td>
